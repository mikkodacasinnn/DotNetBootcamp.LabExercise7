    ...
    class StudentDBManagementSystem
    {
        ...
        public void WriteToFile(DBService dBService)
        {
            if (dBService.GetStudentCount() > 0)
            {
                ...
                string filePath = @$"D:\Documents\Pointwest\bootcamp-backend\repos\CSharp.LabExercise7\fileOutputs\{fileName}";
        ...
        public void LogFile()
        {
            ...
            string filePath = @$"C:\Users\mikko.dacasin\Desktop\MIKKO-CSHARP-SEATWORKS\CSharp.LabExercise7\fileOutputs\{fileName}";
